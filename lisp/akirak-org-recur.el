...
(define-minor-mode akirak-org-recur-mode
  ...
  (if akirak-org-recur-mode
      (progn
        ...
        (keymap-set org-recur-mode-map "C-c C-t" #'akirak-org-recur-todo)
        (keymap-set org-agenda-mode-map
                    "t" #'akirak-org-recur-agenda-todo))
    (progn
      ...
      (keymap-set org-recur-mode-map "C-c C-t" nil)
      (keymap-set org-agenda-mode-map "t" nil))))
