...
This repository uses [[https://github.com/cachix/pre-commit-hooks.nix/][pre-commit-hooks.nix]] for streamlining the development.
...
** License
Most of the configuration was written by myself (Akira Komamura), with an exception of [[file:dotfiles/starship.toml][starship.toml]] which was copied from the repository of [[https://github.com/divnix/devos][devos]] (written by
[[https://github.com/nrdxp][Timothy DeHerrera]]).

I license this configuration under [[file:LICENSE][MIT License]].
