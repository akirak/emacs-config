  ...
  (eval-when-compile
    (define-setup-macro
     ...
     `(dolist (filename ',filenames)
        ...
        (add-to-list 'project-vc-extra-root-markers filename))))
#+end_src
*** :project-roots
:PROPERTIES:
...
#+begin_src emacs-lisp
  (eval-when-compile
    (define-setup-macro
     ...
     (dolist (glob globs)
       (add-to-list 'project-vc-extra-root-markers glob))))
#+end_src
*** :reformatters
:PROPERTIES:
  ...
  (setup files
    ...
    (:status personal
      (let (;; (mix-format '((eval . (mix-format-on-save-mode t))))
            ...
            (envrc '((eval . (akirak/turn-on-envrc-mode))))
            (diff-hl '((eval . (turn-on-diff-hl-mode)))))
      ...
      (dir-locals-set-directory-class "~/work2/" 'edit)
      (dir-locals-set-directory-class "~/org/" 'edit)
      (dir-locals-set-directory-class "~/resources/" 'edit)
...
#+begin_src emacs-lisp
  (setup (:package avy)
    (:set avy-style 'pre
          avy-all-windows t)
    (:global "M-[" #'avy-goto-symbol-1-above
...
#+begin_src emacs-lisp
  (setup (:package elysium)
    ...
    (with-eval-after-load 'embark
      (define-key embark-region-map "q" #'elysium-query))
    (with-eval-after-load 'gptel-rewrite
      (transient-append-suffix 'gptel-rewrite-menu 'gptel--suffix-rewrite
...
#+begin_src emacs-lisp
  (setup (:package exec-path-from-shell)
    (when (or window-system
      ...
      (add-to-list 'exec-path-from-shell-variables "PASSAGE_AGE")
      (add-to-list 'exec-path-from-shell-variables "PASSAGE_DIR")
      (add-to-list 'exec-path-from-shell-variables "PASSAGE_IDENTITIES_FILE")
      (add-to-list 'exec-path-from-shell-variables "PASSAGE_RECIPIENTS_FILE")
