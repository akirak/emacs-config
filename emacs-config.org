...
*** :vc-ignore
:PROPERTIES:
:CREATED_TIME: [2026-08-09 Sun 23:22]
:END:

#+begin_src emacs-lisp
  (eval-when-compile
    (define-setup-macro
     :vc-ignore (&rest patterns)
     (dolist (pattern patterns)
       (cl-pushnew pattern project-vc-ignores))))
#+end_src
...
#+begin_src emacs-lisp
  (setup project
    (:set project-vc-ignores '(".git" ".direnv" "node_modules"
                               ".venv" "target"))
...
| [[org-ql-search:tags:packages][packages]]            | 221 |
