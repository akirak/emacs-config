    ...
    (:when-loaded
      (:set marginalia-annotator-registry
            (append '((project-root
                       ...
                       builtin none))
                    (get 'marginalia-annotator-registry
                         'standard-value)))))
#+end_src
...
| [[org-ql-search:tags:packages][packages]]            | 120 |
