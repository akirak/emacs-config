...
#+begin_src emacs-lisp
  (setup akirak-org-dog
    (:global "<f12> c b" #'akirak-org-dog-capture-backlog
             "<f12> c d" #'akirak-org-dog-capture-datetree-dwim))
#+end_src
...
#+begin_src emacs-lisp
  (setup akirak-url
    (:global "C-c w" #'akirak-url-insert-dwim
             "<f12> c u" #'akirak-url-org-capture)
    (with-eval-after-load 'embark
...
| [[org-ql-search:tags:packages][packages]]            | 170 |
