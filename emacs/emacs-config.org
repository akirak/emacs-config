...
#+begin_src emacs-lisp
  (setup ffap
    (:set ffap-file-finder (defun akirak/ffap-file-finder (file)
                             (if (akirak/ffap-prefer-other-window-p)
    ...
    (defun akirak/ffap-prefer-other-window-p (file &optional dirp)
      ...
      (not (and (buffer-file-name)
                ...
                ;; window.
                (equal (project-root (project-current nil default-directory))
                       (project-root (project-current nil (if dirp
                                                              file
                                                            (file-name-directory
                                                             file))))))))
