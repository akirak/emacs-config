...
*** NixOS
#+begin_src elisp
  (defconst akirak/nixos-configuration-version
    (when-let (exe (executable-find "nixos-version"))
      (car (process-lines exe "--configuration-revision"))))
#+end_src
** Custom conventions
  ...
  (setup frame
    ...
    (defconst akirak/base-frame-title-format
      '((akirak/emacs-profile-name
        ...
        (akirak/os-release
         (" - " akirak/os-release))
        (akirak/nixos-configuration-version
         ("@" akirak/nixos-configuration-version))))
