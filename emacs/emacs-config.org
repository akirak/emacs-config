    ...
    (:status personal
      (:when-loaded
        ...
        (transient-replace-suffix 'magit-branch
          ...
          '("w" "new worktree" akirak-magit-worktree-default)))
...
#+begin_src emacs-lisp
  (setup (:package puni)
    (:hook-into nix-mode svelte-mode)
...
#+begin_src emacs-lisp
  ...
  (setq org-ql-find-goto-hook #'akirak/org-goto-indirect-hook)
