...
*** Tag statistics
The following source block generates a table of tags in this document.
If you have [[https://github.com/alphapapa/org-ql/][org-ql]] installed, you can browse entries matching a tag by pressing =C-c C-o= on a link.
...
| [[org-ql-search:tags:packages][packages]]       | 33 |
...
| [[org-ql-search:tags:writing][writing]]        |  2 |
...
*** Quality of life
There are many ways to improve the quality of life inside Emacs.

Auto-formatting is one of the keys.

#+BEGIN: org-ql :query "tags: formatting" :columns (heading todo)
| Heading           | Todo |
|-------------------+------|
| [[buffer.c][buffer.c]]          |      |
| [[electric][electric]]          |      |
...
- You will want to try out APIs from within Emacs. You can choose either [[https://github.com/pashky/restclient.el][restclient]] or [[https://github.com/federicotdn/verb][verb]].
- I am not sure if Indium or skewer-mode works nowadays. I have never used any of them in real development.
