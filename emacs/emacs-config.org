...
#+begin_src emacs-lisp
  (setup (:package org-memento)
    ...
    (:set org-memento-idle-time 15
          org-memento-agenda-files
          (defun akirak/org-memento-agenda-files ()
            (when-let (dir (org-entry-get nil "project"))
              (let ((default-directory dir))
                (akirak-org-dog-project-files)))))
