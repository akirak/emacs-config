...
#+begin_src emacs-lisp
  (setup org-mode
    ...
    (:option org-complete-tags-always-offer-all-agenda-tags t)
...
#+begin_src emacs-lisp
  (setup org-mode
    (:option org-image-actual-width (ignore-errors
                                      (* 90 (/ (frame-text-width)
                                               (frame-width))))
...
#+begin_src emacs-lisp
  (setup org-agenda
    (:option org-agenda-start-with-clockreport-mode t
...
#+begin_src emacs-lisp
  (setup org-clock
    (:option org-clock-history-length 20
...
#+begin_src emacs-lisp
  (setup org-habit
    (:option org-habit-following-days 7
...
#+begin_src emacs-lisp
  (setup org-src
    (:option org-src-tab-acts-natively t))
#+end_src
**** Tags
#+begin_src emacs-lisp
  (setup org-tags
    (:option org-group-tags t
...
| [[org-ql-search:tags:Emacs][Emacs]]               |   4 |
...
| [[org-ql-search:tags:VC][VC]]                  |   3 |
| [[org-ql-search:tags:links][links]]               |   3 |
| [[org-ql-search:tags:editing][editing]]             |   3 |
