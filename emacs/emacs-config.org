  ...
  (setup (:package org)
    (:with-mode org-mode
      ...
      (:global "C-c o" #'org-open-at-point-global
               "C-c t" #'akirak-org-dwim-on-clock)
...
#+begin_src emacs-lisp
  (setup (:package org-memento)
    ...
    (:with-map help-map
      (:bind "<tab>" #'org-memento-next-action))
...
:PROPERTIES:
:CREATED_TIME: [2022-10-11 Tue 23:59]
:END:
#+begin_quote
Visualize an activity timeline
[[https://git.sr.ht/~akirak/org-memento]]
#+end_quote

#+begin_src emacs-lisp
  (setup (:package org-memento-timeline)
    (:set org-memento-group-depth 2)
    (define-key help-map (kbd "M-p") #'org-memento-planner)
    (:bind "C-c ." #'akirak-org-edit-active-ts))
#+end_src
*** org-ml                                                 :library:
:PROPERTIES:
