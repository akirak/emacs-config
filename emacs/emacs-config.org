  ...
  (setup browse-url
    (:status personal
      (:set browse-url-browser-function #'akirak-browse-url-external-browser
            ...
            browse-url-chromium-arguments '("--profile-directory=Default"))))
#+end_src
...
#+begin_src emacs-lisp
  (setup (:package org-starter)
    ...
    (:status personal
      (:when-loaded
        (org-starter-def "~/config/emacs/emacs-config.org"
          :key "e"))))
#+end_src
*** org-super-agenda
:PROPERTIES:
...
#+end_src
*** affe                                   :noexport:completion:grep:ARCHIVE:
:PROPERTIES:
...
#+end_src
**** akirak-japanese                                       :noexport:ARCHIVE:
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (setup akirak-snippet
    (:global "C-c c s" #'akirak-snippet-capture
             "C-c c S" #'akirak-snippet-capture-tempo)
...
#+end_src
*** browse-at-remote                                       :noexport:ARCHIVE:
:PROPERTIES:
...
#+end_src
*** ediprolog                                       :noexport:Prolog:ARCHIVE:
:PROPERTIES:
...
#+begin_src emacs-lisp
  (setup (:package eros)
    (:hook-into emacs-lisp-mode))
#+end_src
*** esup                                 :noexport:startup:profiling:ARCHIVE:
:PROPERTIES:
...
(setup (:package esup))
#+end_src
*** evil-nerd-commenter                            :noexport:editing:ARCHIVE:
:PROPERTIES:
...
(setup (:package taxy))
#+end_src
*** taxy-magit-section                          :noexport:UI:library:ARCHIVE:
:PROPERTIES:
:CREATED_TIME: [2022-02-02 Wed 23:18]
:END:
#+begin_quote
...
#+begin_src emacs-lisp
  (setup (:package vterm)
    (defun akirak/vterm (&optional dir)
