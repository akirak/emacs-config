...
#+begin_src emacs-lisp
  (setup (:package octopus)
    ...
    (:set octopus-ql-find-options '(:query-prefix "!archived: "))
      ...
      (add-hook 'org-memento-checkin-hook
                (defun akirak/org-memento-insert-clocktable ()
                  ...
                  (insert "#+BEGIN: clocktable :scope agenda"
                          ...
                          "#+END:\n"))
                20)
      (add-hook 'org-memento-checkin-hook #'akirak-org-log-generate-memento-blocks 80)
      (add-hook 'org-memento-checkin-hook
...
| [[org-ql-search:tags:packages][packages]]            | 226 |
