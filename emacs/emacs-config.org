  ...
  (setup files
    ...
    (:status personal
      (let (;; (mix-format '((eval . (mix-format-on-save-mode t))))
            ...
            (yamlfmt '((eval . (yamlfmt-on-save-mode t))))
...
#+begin_src emacs-lisp
  (setup elixir-ts-mode
    ...
    (:bind "C-c C-e" #'akirak-elixir-heex-close-tag)
...
[[https://github.com/gleam-lang/gleam-ts-mode]]
#+end_quote
  ...
  (setup akirak-elec-pair
    (:status opinionated
      (:global "M-i" nil
               ...
               "M-i x" #'akirak-elec-pair-inner-kill
               "M-i w" #'akirak-elec-pair-inner-kill-new
...
#+begin_src emacs-lisp
  (setup (:package twind)
    ...
    (:with-mode twind-class-mode
      (:hook-into web-mode tsx-ts-mode heex-ts-mode gleam-ts-mode)
