...
#+begin_src emacs-lisp
  (setup (:package avy)
    (:set avy-style 'pre)
    (defmacro akirak/avy-define-char-command (name char)
      `(defun ,name ()
         (interactive)
    ...
    (:global "M-[" #'avy-goto-symbol-1-above
             ...
             "M-g |" (akirak/avy-define-char-command akirak/avy-goto-pipe ?\|)
             "M-g (" (akirak/avy-define-char-command akirak/avy-goto-paren ?\()
             "M-g [" (akirak/avy-define-char-command akirak/avy-goto-bracket ?\[)
             "M-g {" (akirak/avy-define-char-command akirak/avy-goto-brace ?\{)))
#+end_src
