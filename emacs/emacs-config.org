...
#+begin_src emacs-lisp
  (setup (:package poet-theme)
    (:set poet-theme-variable-headers nil
          poet-theme-variable-pitch-multiplier 1.0))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (eval-after-load 'shr
    (defun akirak/apply-shr-font-heights ()
      ...
      (set-face-attribute 'shr-h2 nil :height 1.41)
      (set-face-attribute 'shr-h3 nil :height 1.3)
      (set-face-attribute 'shr-h4 nil :height 1.19)
      (set-face-attribute 'shr-h5 nil :height 1.1)
      (set-face-attribute 'shr-h6 nil :height 1.07)))
...
#+begin_src emacs-lisp
  (setup (:package magit)
    ...
    (define-key ctl-x-map (kbd "M-s") #'magit-status)
